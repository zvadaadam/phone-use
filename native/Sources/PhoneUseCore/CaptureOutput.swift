...
public enum BrokerPhase: String, Codable, Sendable {
    case starting
    case waiting
    case permission
    case reconnecting
...
public protocol BrokerLogger: AnyObject {
    func log(_ message: String)
}

public protocol CaptureOutput: BrokerLogger {
